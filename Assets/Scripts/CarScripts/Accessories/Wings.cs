...
public class Wings : MonoBehaviour
{
    ...
    public void AddDownForce()
    {
        ...
        m_Car.m_Rigidbody.AddForceAtPosition(-transform.up * frontDownforce * m_Car.getSpeedFactor(), frontPosition);
        m_Car.m_Rigidbody.AddForceAtPosition(-transform.up * backDownforce * m_Car.getSpeedFactor(), backPosition);
    }
}
